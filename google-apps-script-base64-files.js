// Enhanced Google Apps Script with Base64 file upload functionality
  ...
  try {
    ...
    if (e.parameter.data) {
      try {
        ...
        Logger.log('Parsed form data successfully');
      } catch (parseError) {
        Logger.log('Error parsing JSON data: ' + parseError.toString());
        data = e.parameter;
      }
    } else {
      data = e.parameter;
...
function doGet() {
  return HtmlService.createHtmlOutput(`
    ...
    <html>
      <head>
        <title>ETE Digital Form Handler with Base64 File Upload</title>
        <style>
          body { 
            font-family: Arial, sans-serif; 
            text-align: center; 
      ...
      <body>
        <div class="container">
          ...
          <p>✅ Google Apps Script with Base64 File Upload is working correctly!</p>
