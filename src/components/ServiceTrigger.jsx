...
// export default function ServiceTrigger({ open, setOpen }) {
...
//         { image: "none", path: "/Pages/services/web-development", name: "Web Development" },
...
export default function ServiceTrigger({ open, setOpen }) {
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            >
                <span className="text-[17px] font-semibold capitalize">Services</span>
                <ChevronDown
